...
QT_MOC_LITERAL(1, 10, 18), // "textMessageArrived"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "message"
QT_MOC_LITERAL(4, 38, 11), // "onConnected"
QT_MOC_LITERAL(5, 50, 18), // "processTextMessage"
QT_MOC_LITERAL(6, 69, 7) // "isValid"

    },
    "Websocket\0textMessageArrived\0\0message\0"
    "onConnected\0processTextMessage\0isValid"
};
...
void Websocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Websocket::textMessageArrived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Websocket::textMessageArrived(QString _t1)
{
